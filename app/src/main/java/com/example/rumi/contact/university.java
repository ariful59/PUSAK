...
public class university extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data=dh.university_search();
        final ListView list=(ListView)findViewById(R.id.listview);
        HashMap<String, String> nameAddresses = new HashMap<>();
        for(int i=0;i<data.length;i++) {
            int a=dh.total_university(data[i]);
            //System.out.println(data[i] +" Students "+a);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
               ...
               // System.out.println(res);
                Intent intent = new Intent(university.this, university_list.class);
